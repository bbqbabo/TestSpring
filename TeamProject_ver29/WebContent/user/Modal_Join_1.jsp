			...
			$.ajax({
					...
					success:function(data){
					    ...
					    $('.modal-content').load(url,function(result){
					 	...
					 	Join_Id=$("#Join_id_value").val();
					 	Join_Pw=$("#Join_pw_value").val();
					 });
				  },
				  error:function(data){
							...
							<div class="tab-pane" id="info_5">
								<div class="form-group" id="divPhoto">
									<div class="col-md-5 col-sm-5 col-xs-5" style= "padding-top: 115px;">
										<input class="form-control" type="text" id="Join_profile_value" name="Join_profile_value" readonly="readonly" value="사진을 선택하세요.jpg">
									...
									<div class="col-md-7 col-sm-7 col-xs-7" style="height:295px;">
										...
										<img class="img-circle img-raised img-responsive" src="user/Test.jpg" style="width:280px; height:300px" id="Join_default_pic"/>
									</div>
					            </div>
							</div>
						</div>
