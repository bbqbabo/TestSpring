...
팁게시판 관리자 채택 시 300
질문답변게시판 관리자 채택 시 답변자에게 200, 질문작성 시 -10 ~ -100 소모, 답변을 글쓴이가 채택 시 소모한 포인트 답변자가 받음 
전체게시판 금일 최대 조회수 글에 200
전문가와의 상담 1회 -100 소모 
		                        ...
		                        <form method="post">
		                        	...
		                        	<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input type="text" id="qna_board_point" name="qna_board_point" value="${json.qna_board_point}">  point
											</div>
										</div>
										<div class="form-group">
											<div class="col-md-6">
												[질문답변게시판] 질문 작성 소모 포인트 
											</div>
											<div class="col-md-6">
												최대  <input type="text" id="qna_board_question_point" name="qna_board_question_point" value="${json.qna_board_question_point}">  point
											</div>
										</div>
										<div class="form-group">
											<div class="col-md-6">
											...
											<div class="col-md-6">
												<input type="text" id="board_best_point" name="board_best_point" value="${json.board_best_point}">  point
											</div>
										</div>
										<div class="form-group">
											<div class="col-md-6">
