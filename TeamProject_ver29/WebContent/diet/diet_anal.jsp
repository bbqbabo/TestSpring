...
$(function(){
	  ...
	  $.ajax({
		  ...
		  success:function(data){
			  ...
			  $('#break').html(breakStr);
			  $('#breakCal').html("총  " + parsed.analList[0].아침  + " Kcal");
			  ...
			  $('#lunch').html(lunchStr);
			  $('#lunchCal').html("총  " + parsed.analList[0].점심  + " Kcal");
			  ...
			  $('#dinnerCal').html("총  " + parsed.analList[0].저녁  + " Kcal");
			  
			  $('#totalCal').html("하루  " + (parsed.analList[0].아침*1 + parsed.analList[0].점심*1 + parsed.analList[0].저녁*1) + " Kcal");
			  
			  $('#typography').html(parsed.results);
