...
<div id="getList4" class=" card" style="width:45%;  margin-left:3%;  height:300px; float:left; background-color: #F7B69E;">
               ...
               <div class="row">
                ...
                <div class="alert alert-info" id="avgcal">
                	평균 칼로리:
                                    <span class="pull-right">
                                        <i class="material-icons">trending_up</i>
                                    </span>
                </div>
                <div class="alert alert-info" id="avgcnt">
                 ...
                 --%>
                       ...
                       <%-- <div class="body bg-cyan">
                            <div class="m-b--35 font-bold">${sessionScope.Id } 요약정보</div>
                            <ul class="dashboard-stat-list">
                                 <li>닉네임:${sessionScope.Nickname }</li>
                                <li>
                                    Level:${sessionScope.Level }
                                    <span class="pull-right">
                                        <i class="material-icons">trending_up</i>
                                ...
                                <li id='avgcal'>평균 칼로리:</li>
                                <li id='avgcnt'>평균 운동시간</li>
