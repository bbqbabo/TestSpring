...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#buy_ex2").click(function() {
			...
			location.href = "buy_ex2.do";

		});//end click

		$("#board_Tip").click(function(){
			location.href="board_Tip.do";
		});
		...
		$("#board_Qna").click(function(){
			location.href="board_Qna.do";
		});
...
<body>
    ...
    -->
		<div class="logo">
			<a href="defaultIndex.do" class="simple-text"> 22세기 운동혁명 </a>
		</div>
		<div class="sidebar-wrapper">
			<ul class="nav">
				...
				<li class="menu"><a> <i class="material-icons">shopping_cart</i>
						<p>쇼핑</p>
				</a>
					<ul class="nav submenu">
						<li><a href="javascript:void(0);" id="123">
								<p>구매목록</p>
						</a></li>
						<li><a href="javascript:void(0);" id="buy_ex2">
								<p>판매목록</p>
						</a></li>
					</ul></li>
				<li class="menu"><a> <i class="material-icons">dashboard</i>
					...
					<ul class="nav submenu">
						...
						<li><a href="javascript:void(0);" id="board_Qna">
								<p>Q & A</p>
						</a></li>
					</ul></li>
