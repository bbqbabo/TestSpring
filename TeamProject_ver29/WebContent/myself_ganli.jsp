      ...
      <div class="col-md-9	 well" >
       ...
       <ul class="timeline">
        <li>
          ...
          <div class="timeline-panel">
            <div class="timeline-heading">
              <h4 class="timeline-title">${sessionScope.Id }님의 신상 정보</h4>
            </div>
            <div class="timeline-body">
              <p><strong>이름 : </strong> ${user1.nickname }</p>
			  <p><strong>이메일 : </strong> ${user1.email }</p>
			  <p><strong>전화번호 : </strong> ${user1.phonenum }</p>
			  <p><strong>주소 : </strong>${fn:replace(user1.address,'%',' ') }</p>
            </div>
          </div>
        </li>
        <li>
        ...
        <li>
          ...
          <div class="timeline-panel">
            <div class="timeline-heading">
              <h4 class="timeline-title">운영진의 현재 평가</h4>
            </div>
            <div class="timeline-body">
