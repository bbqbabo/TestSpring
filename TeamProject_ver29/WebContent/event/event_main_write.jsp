				...
				<div class="jumbotron" style="padding-top: 20px;">
					...
					<form method="post" id="form" action="event_main_writeAction.do">
						...
						<div id="cent" style="display: none;">
							...
							<div id="dcate1" class="form-group">
								<span id="cate1"></span>
							...
							<div class="form-group">
								메인 이미지 선택 : <input type="file" class="btn btn-primary" name="mImg" id="mImg" />
								<input type="hidden" id="mainImg" name="mainImg">
							</div>
							<div id="cImg" class="form-group"> 
								내용 이미지 선택 : <input type="file" class="btn btn-primary" name="cImg" id="cImg1">
