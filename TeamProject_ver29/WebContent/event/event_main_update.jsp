			...
			<div class="col-lg-a">
				<div class="jumbotron" style="padding-top: 20px;">
					...
					<form method="post" id="form" action="event_main_writeAction.do">
						...
						<div id="discount" style="display: none;">할인율<input type="text" name="discount" id="discount1"></div>
						<div id="dcate1">
						<span id="cate1"></span>
						...
						메인 이미지 선택 : <input type="file" name="mImg" id="mImg" />
						<span id="mainIMG">현재 메인 이미지 : ${a.imgMain }</span>
						<div id="cImg"> 내용 이미지 선택 : <input type="file" name="cImg" id="cImg1" >
						<span id="contentIMG">현재 내용 이미지 : ${a.imgContent }</span></div>
						<div id="date">기한 : <input	type="date"  name="date" id="date1" value="${a.date }"></div>
